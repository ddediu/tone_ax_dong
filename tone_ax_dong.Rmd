...
supp_mats <- TRUE; # supplementary materials, so figure and table numbering starts with S
...
- *Figures:*
  ...
  + [Figures S94-S99. Comparing the complex path models for % correct responses and d' on the original, recoded and removed datasets.](#FigS94)
...
g <- set_node_attrs(g, "label",     c("educ",  "age",   "gender",  "wm",    "pcr",         "loc"));
...
render_graph(g);
DiagrammeR::export_graph(g, file_name="./paper/figures/path_model.pdf", file_type="pdf");
DiagrammeR::export_graph(g, file_name="./paper/figures/path_model.png", file_type="png", width=10*72, height=10*72); # assuming 72 DPI
```
